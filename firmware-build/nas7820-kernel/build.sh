...
# cp "$patch/bc.makefile" "$target/feeds_packages_utils_bc.Makefile"
cp "$patch/ipset-dns.makefile" "$target/package/network/services/ipset-dns/Makefile"
cp "$patch/openvpn.makefile" "$target/package/network/services/openvpn/Makefile"
cp "$patch/xfsprogs.makefile" "$target/package/utils/xfsprogs/Makefile"
