...
static void mv88f5181L_reset(DeviceState *d) {
    ...
    s->csn2_bar_size = 0x0;
    s->csn3_bar_size = 0x0;
    s->devcsn0_bar_size = 0x0;
    s->devcsn1_bar_size = 0x0;
    s->devcsn2_bar_size = 0x0;
    s->boot_csn_bar_size = 0x0;
    s->p2p_mem0_bar_size = 0x0;
    s->p2p_i_or_o_bar_size = 0x0;
    s->expansion_rom_bar_size = 0x0;
    s->base_address_registers_enable = 0x0;
    s->csn0_base_address_remap = 0x0;
    s->csn1_base_address_remap = 0x0;
    s->csn2_base_address_remap = 0x0;
    s->csn3_base_address_remap = 0x0;
    s->devcsn0_base_address_remap = 0x0;
    s->devcsn1_base_address_remap = 0x0;
    s->devcsn2_base_address_remap = 0x0;
    s->bootcsn_base_address_remap = 0x0;
    s->p2p_mem0_base_address_remap_low = 0x0;
    s->p2p_mem0_base_address_remap_high = 0x0;
    s->p2p_i_or_o_base_address_remap = 0x0;
    s->expansion_rom_base_address_remap = 0x0;
    s->dram_bar_bank_select = 0x0;
    s->pci_address_decode_control = 0x0;
    s->pci_dll_control = 0x0;
    s->pci_or_mpp_pads_calibration = 0x0;
    s->pci_command = 0x0;
    s->pci_mode = 0x0;
    s->pci_retry = 0x0;
    s->pci_discard_timer = 0x0;
    s->msi_trigger_timer = 0x0;
    s->pci_arbiter_control = 0x0;
    s->pci_p2p_configuration = 0x0;
    s->pci_access_control_base_0_low = 0x0;
    s->pci_access_control_base_0_high = 0x0;
    s->pci_access_control_size_0 = 0x0;
    s->pci_access_control_base_1_low = 0x0;
    s->pci_access_control_base_1_high = 0x0;
    s->pci_access_control_size_1 = 0x0;
    s->pci_access_control_base_2_low = 0x0;
    s->pci_access_control_base_2_high = 0x0;
    s->pci_access_control_size_2 = 0x0;
    s->pci_access_control_base_3_low = 0x0;
    s->pci_access_control_base_3_high = 0x0;
    s->pci_access_control_size_3 = 0x0;
    s->pci_access_control_base_4_low = 0x0;
    s->pci_access_control_base_4_high = 0x0;
    s->pci_access_control_size_4 = 0x0;
    s->pci_access_control_base_5_low = 0x0;
    s->pci_access_control_base_5_high = 0x0;
    s->pci_access_control_size_5 = 0x0;
    s->pci_configuration_address = 0x0;
    s->pci_configuration_data = 0x0;
    s->pci_interrupt_acknowledge = 0x0;
    s->pci_serrn_mask = 0x0;
    s->pci_interrupt_cause = 0x0;
    s->pci_interrupt_mask = 0x0;
    s->pci_error_address_low = 0x0;
    s->pci_error_address_high = 0x0;
    s->pci_error_command = 0x0;
