...
class Extraction(Analysis):
    def run(self, firmware):
        ...
        if image_type == 'legacy uImage':
            ...
            self.info(firmware, '\033[32mget kernel image {} at {}\033[0m'.format(os.path.basename(kernel), kernel), 1)
            ...
            self.info(
                firmware, '\033[32mget device tree image {} at {}\033[0m'.format(os.path.basename(kernel), dtb), 1)
