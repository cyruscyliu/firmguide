...
class Strings(Analysis):
    ...
    def find_machine_id_by_strings(self, firmware):
        candidates = {
            "1788": {
            ...
            "1781": {
                "machine_description": "DaVinci DA830/OMAP-L137/AM17x EVM",
            ...
            "2157": {
                "machine_description": "DaVinci DA850/OMAP-L138/AM18x EVM",
            ...
            "1827": {
                "machine_description": "PXA930 Evaluation Board (aka TavorEVB)",
            ...
            "1236": {
                "machine_description": "LogicPD i.MX31 SOM",
            ...
            "387": {
                "machine_description": "ARM-Versatile (Device Tree Support)",
        ...
        target_strings = {}
        votes = {}
        for k, machine_properties in candidates.items():
        ...
        if len(target_machine_id):
            firmware.set_board_id(target_machine_id[0][0])
            self.info(
                firmware, 'get machine id: {}, take the first one by default'.format(target_machine_id), 1)
            return True
        else:
            return False
    ...
    def run(self, firmware):
        ...
        self.find_machine_id_by_strings(firmware)
